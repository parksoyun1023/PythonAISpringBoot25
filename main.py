...
#요청과 응답 사이에 요청
#미들웨어는 모든 요청에 대해 실행되며 , 요청을 처리하기 전에 응답을 반환하기 전에 특정 작업을 수행 할 수 있음
#예를 들어 로깅, 인증, cors처리 , 입축등....
import logging

app = FastAPI( #앱의 시그니처와 환경설정을 담당
    title="MBC AI Study",#앱의 제목
    description="A simple AI study", #앱의 주석
    version="0.0.1", #앱의 버전
...
#                   파이썬 백엔드 가동 서버로 main.py에 app이라는 메서드 사용
#                                  갱신        포트번호 변경 8001